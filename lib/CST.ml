...
type enum_variant = (
    identifier (*tok*)
  * [ `Struct_body of struct_body | `Anon_fields of anon_fields ]
)
...
type variant = [
    `Choice_enum_vari_opt_COMMA of [
        `Enum_vari_opt_COMMA of (enum_variant * Token.t (* "," *) option)
      | `Id_COMMA of (identifier (*tok*) * Token.t (* "," *))
    ]
  | `Ellips of Token.t (* "..." *)
]
